...
use MuckiLogPlugin\Log4php\Appenders\LoggerAppenderEcho;
use MuckiLogPlugin\Log4php\Appenders\LoggerAppenderNull;
...
class LoggerAppenderTest extends TestCase
{
    ...
    public function testInstanciateWithLayout()
    {
    	...
    	$expected = "MuckiLogPlugin\Log4php\layouts\LoggerLayoutSimple";
