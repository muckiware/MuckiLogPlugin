...
{
	private array $testConfig1 = array (
		'rootLogger' =>	array (
			'level' => 'ERROR',
			'appenders' => array (
				'default',
	...
	private array $testConfig2 = array (
		'appenders' => array (
			'default' => array (
				'class' => 'MuckiLogPlugin\Log4php\Appenders\LoggerAppenderEcho',
			),
	...
	// For testing additivity
	private array $testConfig3 = array (
		'appenders' => array (
			'default' => array (
				'class' => 'MuckiLogPlugin\Log4php\Appenders\LoggerAppenderEcho',
			),
	...
	public function testCanLogToAllLevels()
    {
        ...
        $e .= 'TRACE - this is a trace message'.PHP_EOL;
	...
	public function testIsEnabledFor()
    {
		...
		self::assertTrue($logger->isTraceEnabled());
