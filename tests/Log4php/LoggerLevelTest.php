...
class LoggerLevelTest extends TestCase
{
	...
	public function testLevelFatal() {
		$this->doTestLevel(LoggerLevel::getLevelCritical(), LoggerLevel::CRITICAL, 'CRITICAL', LOG_ALERT);
		$this->doTestLevel(LoggerLevel::toLevel(LoggerLevel::CRITICAL), LoggerLevel::CRITICAL, 'CRITICAL', LOG_ALERT);
		$this->doTestLevel(LoggerLevel::toLevel('CRITICAL'), LoggerLevel::CRITICAL, 'CRITICAL', LOG_ALERT);
    }
